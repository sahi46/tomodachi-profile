...
function UnderlineField({ label, answer, colors, editMode }: {
...
function BoxField({ label, answer, colors, editMode }: {
  label: string; answer: string; colors: CardColors; editMode?: boolean
}) {
  return (
    <div style={{ marginBottom: 6 }}>
...
function RibbonField({ label, answer, colors, editMode }: {
  label: string; answer: string; colors: CardColors; editMode?: boolean
}) {
  return (
...
export default function TemplateCard({ template, answers, editMode }: Props) {
